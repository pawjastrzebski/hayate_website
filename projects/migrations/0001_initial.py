# Generated by Django 2.1.7 on 2019-03-07 23:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'manga'), (1, 'anime'), (2, 'gra'), (3, 'light novel')])),
                ('is_hentai', models.IntegerField()),
                ('description', models.TextField()),
                ('total_volumes', models.SmallIntegerField()),
                ('state_japan', models.IntegerField(choices=[(0, 'Powstaje'), (1, 'Zakończona')])),
            ],
            options={
                'db_table': 'titles',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation_type', models.PositiveSmallIntegerField(choices=[(0, 'Doujin'), (1, 'Sequel'), (2, 'Prequel'), (3, 'Historia poboczna')])),
            ],
            options={
        ...
        migrations.AddField(
            model_name='titlerelate',
            name='title',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='title', to='projects.Title'),
        ),
        migrations.AddField(
            model_name='titlerelate',
            name='title_related',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='title_related', to='projects.Title'),
        ),
        migrations.AddField(
            model_name='title',
            name='authors',
        ...
        migrations.AddField(
            model_name='title',
            name='relations',
            field=models.ManyToManyField(related_name='relation', through='projects.TitleRelate', to='projects.Title'),
        ),
        migrations.AddField(
